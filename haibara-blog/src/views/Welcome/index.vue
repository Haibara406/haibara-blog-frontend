...
const mySwitch = () => {
  if (flag.value) {
    ...
    imgRef.value.src = 'https://minio.haikari.top/haibara-blog/login%2Faaa.png'
  } else {
    // 切换到登录页面
    preBoxRef.value.style.transform = 'translateX(0%)'
    preBoxRef.value.style.backgroundColor = '#edd4dc'
    imgRef.value.src = 'https://minio.haikari.top/haibara-blog/login%2FEMO.png'
  }
  ...
  <div class="welcome-page">
    ...
    <div class="welcome-container">
      ...
      <div class="pre-box" ref="preBoxRef">
        ...
        <p>JOIN US!</p>
        <div class="img-box">
          <img ref="imgRef" src="https://minio.haikari.top/haibara-blog/login%2FEMO.png" alt="">
        </div>
      </div>
