...
import com.blog.constants.IpConst;
import com.blog.constants.ThirdPartyInterfaceConst;
import com.blog.domain.dto.IpResult;
import com.blog.domain.entity.BlackList;
import com.blog.domain.entity.Log;
import com.blog.domain.entity.LoginLog;
import com.blog.domain.entity.User;
import com.blog.domain.ip.IpDetail;
import com.blog.handler.GlobalUncaughtExceptionHandler;
...
public class IpServiceImpl implements IpService, DisposableBean {
    ...
    public void refreshIpDetailAsyncByUidAndRegister(Long uid) {
        EXECUTOR.execute(() -> {
            ...
            if (Objects.nonNull(ipDetail)) {
                ...
                user.setRegisterAddress(IpConst.UNKNOWN_ADDR);
    ...
    public void refreshIpDetailAsyncByLogIdAndLogin(Long loginLogId) {
        EXECUTOR.execute(() -> {
            ...
            if (Objects.nonNull(ipDetail)) {
                ...
                loginLog.setAddress(IpConst.UNKNOWN_ADDR);
    ...
    public void refreshIpDetailAsyncByLogId(Long logId) {
        EXECUTOR.execute(() -> {
            ...
            if (Objects.nonNull(ipDetail)) {
                ...
                log.setAddress(IpConst.UNKNOWN_ADDR);
    ...
    private String buildAddr(String region, String city, String country) {
        if (IpConst.INTERNAL_IP.equals(city)) {
            return IpConst.INTERNAL_IP;
        }

        if (!IpConst.CHINA.equals(country)) {
            return country;
        }

        boolean isRegionUnknown = IpConst.UNKNOWN.equals(region);
        boolean isCityUnknown = IpConst.UNKNOWN.equals(city);

        if (isRegionUnknown && isCityUnknown) {
            return IpConst.UNKNOWN_ADDR;
        }
